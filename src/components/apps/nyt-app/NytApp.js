...
import NtyResults from "./NytResults"
const baseURL = 'https://api.nytimes.com/svc/search/v2/articlesearch.json';
const key = 'AVOIBp3ll3EAVI9X2GXuMKGJrlxAjeki';
  ...
  const changePageNumber = (event, direction) => {
    ...
    return ( 
      ...
      <form onSubmit={(e) => handleSubmit(e)}>
        ...
        { results.length > 0 ? <NtyResults results= {results} changePage = {changePageNumber} /> : null }
      </div>
    </div>
     );
}
